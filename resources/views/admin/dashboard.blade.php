...
<script>
    async function readActivityLogs() {
        ...
        activityLog.forEach(function(value) {
            updateLogDiv += `<div class="activity-item d-flex">
                  <div class="activite-label">${value.logTime}</div>
        ...
        activityLogSection.html(updateLogDiv);
